...
def get_conversation_chain(vectorstore):
    ...
    llm = HuggingFaceHub(repo_id="mistralai/Mistral-7B-Instruct-v0.2", model_kwargs={"temperature":0.1, "max_new_tokens":512, "return_full_text":False}, huggingfacehub_api_token="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")
...
add_routes(app, convo_chain)
# add_routes(app, convo_chain, input_type=Input, output_type=Output )
# add_routes(app, handle_userinput(), input_type=Input, output_type=Output )


if __name__ == "__main__":
    import uvicorn

    # uvicorn.run(app, host="192.168.1.161", port=8000)
